...
└── spider2-lite
    ...
    └── resource
        └── databases
            ...
            ├── snowflake
            ├── sqlite
            └── spider2-localdb #This is the downloaded database folder.
...
sqlite
└── AdventureWorks
    └── AdventureWorks_M-Schema.json  # Move the corresponding JSON file into the database folder of the same name
```
